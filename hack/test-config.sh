...
ADMINCLIENT_NUM=${ADMINCLIENT_NUM:-1}
...
ADMINCLIENT_INSTANCE_PREFIX=${ADMINCLIENT_INSTANCE_PREFIX:-"${INSTANCE_PREFIX}-adminclient"}
...
SIM_WAIT_DOWN_TIME=${SIM_WAIT_DOWN_TIME:-"4,10"}
SIM_DATA_PATTERN=${SIM_DATA_PATTERN:-"Daily,Outage"}
SIM_DOWN_RP_NUM=${SIM_DOWN_RP_NUM:-"0,1"}
...
# Admin client instance parameter
ADMINCLIENT_SOURCE_INSTANCE=${ADMINCLIENT_SOURCE_INSTANCE:-"${SOURCE_INSTANCE}"}
ADMINCLIENT_SOURCE_DISK=${ADMINCLIENT_SOURCE_DISK:-"${SOURCE_DISK}"}
ADMINCLIENT_SOURCE_DISK_ZONE=${ADMINCLIENT_SOURCE_DISK_ZONE:-"${SOURCE_DISK_ZONE}"}
ADMINCLIENT_IMAGE_NAME=${ADMINCLIENT_IMAGE_NAME:-"${IMAGE_NAME}"}
ADMINCLIENT_ZONE=${ADMINCLIENT_ZONE:-"${ADMINCLIENT_SOURCE_DISK_ZONE}"}

#teardown parameter
AUTO_DELETE=${AUTO_DELETE:-true}
SERVER_AUTO_DELETE=${SERVER_AUTO_DELETE:-${AUTO_DELETE}}
CLIENT_AUTO_DELETE=${CLIENT_AUTO_DELETE:-${AUTO_DELETE}}
SIM_AUTO_DELETE=${SIM_AUTO_DELETE:-${AUTO_DELETE}}
ADMINCLIENT_AUTO_DELETE=${ADMINCLIENT_AUTO_DELETE:-${AUTO_DELETE}}
IMAGE_AUTO_DELETE=${IMAGE_AUTO_DELETE:-true}
SERVERIMAGE_AUTO_DELETE=${SERVERIMAGE_AUTO_DELETE:-${IMAGE_AUTO_DELETE}}
CLIENTIMAGE_AUTO_DELETE=${CLIENTIMAGE_AUTO_DELETE:-${IMAGE_AUTO_DELETE}}
ADMINCLIENTIMAGE_AUTO_DELETE=${ADMINCLIENTIMAGE_AUTO_DELETE:-${IMAGE_AUTO_DELETE}}
SIMIMAGE_AUTO_DELETE=${SIMIMAGE_AUTO_DELETE:-${IMAGE_AUTO_DELETE}}
...
ADMINCLIENT_LOG_DIR=${ADMINCLIENT_LOG_DIR:-"${DIR_ROOT}/logs"}
DES_LOG_DIR=${DES_LOG_DIR:-"${DIR_ROOT}/grs/logs/$((${SIM_NUM}*${SIM_RP_NUM}*${NODES_PER_RP}))"}
...
ADMINCLIENT_LOG_LEVEL=${ADMINCLIENT_LOG_LEVEL:-3}
...
ADMINCLIENT_CODE_ROOT=${ADMINCLIENT_CODE_ROOT:-"/home/sonyali/go/src/global-resource-service"}
SERVICE_EXTRA_ARGS=${SERVICE_EXTRA_ARGS:-}
SIM_EXTRA_ARGS=${SIM_EXTRA_ARGS:-}
CLIENT_EXTRA_ARGS=${CLIENT_EXTRA_ARGS:-}
ADMINCLIENT_EXTRA_ARGS=${ADMINCLIENT_EXTRA_ARGS:-}
...
####if true, will start admin testing: node query for now
ENABLE_ADMIN_E2E=${ENABLE_ADMIN_E2E:-false}
SINGLE_NODE_NUM=${SINGLE_NODE_NUM:-}
