...
type Interface interface {
	...
	ResultChan() <-chan runtime.NodeEvent
}

type emptyWatch chan runtime.NodeEvent
...
func NewEmptyWatch() Interface {
	ch := make(chan runtime.NodeEvent)
	close(ch)
...
func (w emptyWatch) ResultChan() <-chan runtime.NodeEvent {
	return chan runtime.NodeEvent(w)
}
